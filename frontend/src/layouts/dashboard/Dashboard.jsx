...
import React, { useState, useEffect } from 'react';
import Sidenav from '../../components/sidenav/Sidenav.jsx'; // ✅ Correct relative path
import Navbar from '../../components/navbar/Navbar.jsx'; // ✅ Added .jsx for consistency
import { CircularProgress, CircularProgressLabel } from '@chakra-ui/react';
          ...
          <div className='welcome-main-container'>
            <div className='welcome-left-container'>
              ...
              <p className='mng-para'>
                In this task management hub, the system seamlessly orchestrates task creation,
                assignment, and tracking, ensuring projects move forward smoothly and collaboratively.
              </p>
            </div>
            <div className='welcome-right-container'>
              <img className='welcome-img' src={welcome} alt="welcome" />
              ...
              <div className='task-status-card-container'>
                ...
                <div className='task-status-progress-main-container'>
                  ...
                  <div>
                    ...
                    <p className='progress'>Inactive</p>
                  </div>
                  <div>
                    <CircularProgress value={20} color='#F21E1E' size='100px'>
                      <CircularProgressLabel>20%</CircularProgressLabel>
                    </CircularProgress>
                    <p className='pending'>Terminated</p>
                  </div>
                </div>
              </div>
